...
### Dynamic MERN Lab (Lab 12)

1. Start local MongoDB.
2. Open a terminal in `Lab_12_MERN_Stack_Nextjs_Dynamic_App_Lab/ecommerce-app/backend`.
3. Run:
...
4. Open another terminal in `Lab_12_MERN_Stack_Nextjs_Dynamic_App_Lab/ecommerce-app/frontend`.
5. Run:
